USE [master]
GO
/****** Object:  Database [MyComp]    Script Date: 29/04/2021 11:31:57 ******/
...
USE [MyComp]
GO
/****** Object:  Table [dbo].[Departments]    Script Date: 29/04/2021 11:31:57 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Shifts]    Script Date: 29/04/2021 11:31:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Workers]    Script Date: 29/04/2021 11:31:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WorkRoles]    Script Date: 29/04/2021 11:31:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Shifts] ([WHId], [DOW], [WHDate], [Numer], [WHIn], [WHOut], [WHTotalHours], [WH100P], [WH125P], [WH150P], [WH175P], [WH200P], [WrkrNumber], [IsHourly], [HourlyPrice], [TripPrice], [IsGlobally], [GloballyTotal], [Status]) VALUES (2, NULL, 0, 0, 0, 0, CAST(0.00 AS Decimal(6, 2)), CAST(0.00 AS Decimal(6, 2)), CAST(0.00 AS Decimal(6, 2)), CAST(0.00 AS Decimal(6, 2)), CAST(0.00 AS Decimal(6, 2)), CAST(0.00 AS Decimal(6, 2)), 0, 0, CAST(0.00 AS Decimal(6, 2)), CAST(0.00 AS Decimal(6, 2)), 0, CAST(0.00 AS Decimal(10, 2)), NULL)
GO
...
GO
ALTER TABLE [dbo].[Shifts] ADD  DEFAULT ((0)) FOR [WHDate]
GO
ALTER TABLE [dbo].[Shifts] ADD  DEFAULT ((0)) FOR [Numer]
GO
ALTER TABLE [dbo].[Shifts] ADD  DEFAULT ((0)) FOR [WHIn]
GO
ALTER TABLE [dbo].[Shifts] ADD  DEFAULT ((0)) FOR [WHOut]
GO
