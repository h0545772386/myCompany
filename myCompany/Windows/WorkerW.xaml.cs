...
namespace myCompany
{
    ...
    public partial class WorkerW : Window
    {
        ...
        private List<WorkRole> LRols;      // רשימת תפקידים
        private List<Worker> LManagers;    // רשימת מנהלים
        private List<Department> LDeprs;   // רשימת מחלקות
